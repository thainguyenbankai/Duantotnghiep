...
export default function AdminOrderList() {
  ...
  try {
    ...
    // 🔥 Đồng bộ: nếu completed thì paymentStatus = paid
    let finalPaymentStatus = newPaymentStatus || order?.paymentStatus || "unpaid";
    ...
    const updateData = {
      status: newStatus,
      paymentStatus: order?.paymentMethod === "BANK" ? "paid" : finalPaymentStatus,
    };

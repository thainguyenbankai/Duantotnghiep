      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        <table className="min-w-full">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {orders.length === 0 ? (
              <tr>
                <td colSpan="11" className="px-6 py-8 text-center text-gray-500">Không có đơn hàng nào</td>
              </tr>
            ) : (
                ...
                <>
                  <tr key={order._id || index} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-sm font-medium">
                      {formatPrice(order.products?.reduce((total, product) =>
                      ...
                      <td colSpan="11" className="px-0 py-0">
                        <div className="bg-gray-50 border-t border-b">
                          <div className="px-6 py-4">
                            ...
                            {/* Thông tin khách hàng + đơn hàng + tổng kết */}

                            ...
                            orders.map((order, index) => (
                                <tr key={order._id || index} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 text-sm font-medium">
                                        {formatPrice(order.products?.reduce((t, p) => t + (p.productPrice * p.productQuantity), 0))}
                                    </td>
                                    ...
                                    <td className="px-6 py-4 text-sm">
                                        {order.status === "completed" ? (
                                            <span className={`px-2 py-1 rounded text-xs ${order.paymentStatus === 'paid' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
                                                {order.paymentStatus}
                                            </span>

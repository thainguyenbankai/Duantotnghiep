                      ...
                      <td colSpan="11">
                        <div className="bg-gray-50 border-t">
                          <div className="px-6 py-4">
                            <h4 className="font-semibold mb-3">Chi tiết đơn #{order._id?.slice(-8)}</h4>
                              ...
                              <table className="w-full text-sm">
                                <thead className="bg-gray-100">
                                  <tr>
                                    ...
                                    <th className="px-3 py-2 text-center">Màu</th>
                                ...
                                <tbody>
                                  {order.products?.map((product, idx) => (
                                    <tr key={idx} className="border-t">
                                      ...
                                      <td className="px-3 py-2 text-center">{product.productSize || "-"}</td>
                                      <td className="px-3 py-2 text-center">{product.productColor || "-"}</td>
                                      <td className="px-3 py-2 text-right">{formatPrice(product.productPrice)}</td>
                                      <td className="px-3 py-2 text-center">{product.productQuantity}</td>

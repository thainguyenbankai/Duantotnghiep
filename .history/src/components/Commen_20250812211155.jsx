...
export default function TabContent({ product, comments, }) {
  ...
  <div classn="max-w-4xl mx-auto">
    <h1 class="text-3xl font-bold mb-6 text-gray-800">Chính Sách Đổi/Trả Hàng</h1>
    ...
    <h2 class="text-xl font-semibold text-gray-800 mt-6 mb-2">1. Thời hạn đổi/trả</h2>
    ...
    <h2 class="text-xl font-semibold text-gray-800 mt-6 mb-2">2. Điều kiện áp dụng</h2>
    <ul class="list-disc list-inside text-gray-700 mb-4">
    ...
    <h2 class="text-xl font-semibold text-gray-800 mt-6 mb-2">3. Các trường hợp không hỗ trợ đổi/trả</h2>
    <ul class="list-disc list-inside text-gray-700 mb-4">
    ...
    <h2 class="text-xl font-semibold text-gray-800 mt-6 mb-2">4. Quy trình đổi/trả</h2>
    ...
    <h2 class="text-xl font-semibold text-gray-800 mt-6 mb-2">5. Chi phí vận chuyển</h2>
    <p class="text-gray-700 mb-4">
    ...
    <h2 class="text-xl font-semibold text-gray-800 mt-6 mb-2">6. Hoàn tiền</h2>
    <p class="text-gray-700 mb-4">
    ...
    <h2 class="text-xl font-semibold text-gray-800 mt-6 mb-2">7. Liên hệ hỗ trợ</h2>

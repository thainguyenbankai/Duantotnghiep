    ...
    return (
        <div>
            ...
            <div className="mt-6">
                ...
                {activeTab === 'payment' && (
                    <div>
                        <h2 className="text-xl font-bold mb-2">Chính sách thanh toán</h2>
                        <p className='mt-4'>T1. COD: Thanh toán khi nhận hàng (COD) <br />
                            Nhận hàng và thành toán thông qua đơn vị giao hàng. <br />
                            2. Alepay: Thanh toán trực tuyến</p>
                        <div className="flex gap-4 mt-4">
                            <img src="https://alepay.vn/images/partner/JCB.png" alt="Alipay" />
                            <img src="https://alepay.vn/images/partner/VISA.png" alt="VISA" />
                            <img src="https://alepay.vn/images/partner/JCB.png" alt="MasterCard" />

                        </div>
                        <p className='mt-4 mb-4'>
                            Thanh toán trực tuyến tại cổng thanh toán Alepay. <br />
                            Nhận hàng thông qua đơn vị giao hàng. <br />
                            3. Chuyển khoản ngân hàng: Thanh toán qua TÀI KHOẢN NGÂN HÀNG <br />
                            Khi chuyển khoản, quý khách vui lòng nhập nội dung chuyển khoản:<br />
                            Tên khách hàng - Số điện thoại<br />
                            Nhận hàng thông qua đơn vị giao hàng.<br />
                        </p>
                    </div>
                )}

...
export default function Home() {
  ...
  useEffect(() => {
    axios
      .post("https://new-server-e.onrender.com/api/product/list?limit=12")
      .then((res) => {
    ...
    axios
      .post("https://new-server-e.onrender.com/api/product/list?limit=100", {
        soldAmount: 1,
      })
      .then((res) => {
        const data = res.data?.data?.data || [];
  ...
  return (
    <>
      <div className="">
        <img
          src="https://file.hstatic.net/200000584505/file/bia_home_64f88b60f8fd4473925d520fd9a8982d.png"
          alt="banner"
          className="w-full"
        />
      </div>
      ...
      <div className="container mx-auto p-4">
        ...
        <Swiper
          ...
          speed={800}
          loop={products1.length > 5} // Chỉ bật khi đủ
                ...
                <div className="relative overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 w-full flex justify-center gap-4 opacity-0 group-hover:opacity-100 transition-all duration-300  py-2">
                    ...
                    <Link
                      ...
                      className="text-black hover:text-red-700 transition duration-200 relative group"
                    >
                      Xem Thêm
        ...
        <div>
          <Link to="/product">
            <p className="text-center text-black hover:text-red-500 mt-8">
              Xem thêm
            </p>
          </Link>
        </div>
        ...
        <div className=" min-h-screen px-6 py-10">
          <div className="text-center py-12 ">
            <h2 className="text-3xl text-gray-900 mb-6">SẢN PHẨM BÁN CHẠY</h2>

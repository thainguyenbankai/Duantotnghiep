...
export default function TabContent({ product, comments, }) {
    ...
    return (
      ...
      <div className="max-w-5xl mx-auto">
        {/* Tiêu đề */}
        <h1 className="text-3xl font-bold mb-6 text-gray-800">Chính Sách Thanh Toán</h1>
        <p className="text-gray-700 mb-6">
          Chúng tôi cam kết mang đến cho khách hàng những trải nghiệm thanh toán an toàn, nhanh chóng và tiện lợi. 
          Chính sách này quy định các phương thức, điều kiện và quy trình thanh toán khi mua sắm tại cửa hàng/website của chúng tôi.
        </p>
        ...
        <h2 className="text-xl font-semibold text-gray-800 mt-6 mb-2">1. Phương thức thanh toán</h2>
        <ul className="list-disc list-inside text-gray-700 space-y-2 mb-6">
          <li><strong>Thanh toán khi nhận hàng (COD):</strong> Khách hàng thanh toán trực tiếp cho nhân viên giao hàng.</li>
          <li><strong>Chuyển khoản ngân hàng:</strong> Thanh toán qua số tài khoản được cung cấp sau khi đặt hàng.</li>
          <li><strong>Thanh toán online:</strong> Hỗ trợ các ví điện tử như Momo, ZaloPay, VNPay, ShopeePay.</li>
          <li><strong>Thẻ quốc tế & nội địa:</strong> Visa, Mastercard, JCB, Napas.</li>
        </ul>

        {/* Ảnh minh họa thanh toán */}
        <img
          src="https://bizflyportal.mediacdn.vn/bizflyportal/techblog/hinh-thuc-thanh-toan-2-16907919425147.jpg"
        ...
        <ul className="list-disc list-inside text-gray-700 space-y-2 mb-6">
          <li>Số tiền thanh toán phải khớp với giá trị đơn hàng đã đặt.</li>
          <li>Đối với chuyển khoản: Khách hàng ghi rõ mã đơn hàng trong nội dung chuyển tiền.</li>
          <li>Thanh toán online qua cổng bảo mật SSL, đảm bảo thông tin cá nhân an toàn.</li>
        </ul>

        {/* 3. Quy trình thanh toán */}
        <h2 className="text-xl font-semibold text-gray-800 mt-6 mb-2">3. Quy trình thanh toán</h2>
        <ol className="list-decimal list-inside text-gray-700 space-y-2 mb-6">
          <li>Khách hàng lựa chọn sản phẩm và tiến hành đặt hàng.</li>
        ...
        {/* <img
          ...
          alt="Quy trình thanh toán"
          className="w-full rounded-lg shadow mb-8"
        /> */}

        {/* 4. Hoàn tiền */}
        <h2 className="text-xl font-semibold text-gray-800 mt-6 mb-2">4. Chính sách hoàn tiền</h2>
        <p className="text-gray-700 mb-6">
          Trong trường hợp đơn hàng bị hủy hoặc thanh toán nhầm, chúng tôi sẽ hoàn tiền vào tài khoản của khách hàng trong vòng <strong>3–5 ngày làm việc</strong>. 
          Đối với thanh toán qua ví điện tử hoặc thẻ, thời gian hoàn tiền có thể lâu hơn tùy thuộc vào ngân hàng hoặc đơn vị trung gian.
        </p>

        {/* 5. Liên hệ */}
        <h2 className="text-xl font-semibold text-gray-800 mt-6 mb-2">5. Liên hệ hỗ trợ</h2>
  ...
  <div className="max-w-4xl mx-auto">
    ...
    <img src="https://file.hstatic.net/200000584505/file/quy_dinh_doi_tra_heng_grande.jpg" alt="ảnh chính sách đổi " />
    ...
    <ul className="list-disc list-inside text-gray-700 mb-4">
      <li>Khách hàng có thể đổi hoặc trả hàng trong vòng <strong>7 - 14 ngày</strong> kể từ ngày nhận sản phẩm.</li>
